...
from app.api.v1 import auth_routes, admin_routes, connector_routes, customer_routes, ia_master_routes
...
api_router.include_router(customer_routes.router, prefix="/master", tags=["Master Data - Customers"])
