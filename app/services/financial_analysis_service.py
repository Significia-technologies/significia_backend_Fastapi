            ...
            'steps': [
                {
                    ...
                    'calculation': f'Current Cost: Rs {calculations.get("education_corpus_today", 0):,}\nInflation: {assumptions.get("inflation", 6)}%\nYears: {assumptions.get("education_years", 5)}',
                ...
                },
                {
                    ...
                    'calculation': f'Net Requirement: Rs {calculations.get("education_net_corpus", 0):,}',
            ...
            'steps': [
                {
                    ...
                    'calculation': f'Monthly Expenses: Rs {int(total_expenses / 12):,}\n6 months coverage',
